                    ...
                    <div className="w-full">
                        <div className="bg-white rounded-2xl overflow-hidden shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
                            ...
                            <div className="p-6">
                                ...
                                <p className="text-gray-600 text-center">Description of Facility 1 goes here.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-full">
                        <div className="bg-white rounded-2xl overflow-hidden shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
                            ...
                            <div className="p-6">
                                ...
                                <p className="text-gray-600 text-center">Description of Facility 2 goes here.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-full">
                        <div className="bg-white rounded-2xl overflow-hidden shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
                            ...
                            <div className="p-6">
                                ...
                                <p className="text-gray-600 text-center">Description of Facility 3 goes here.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-full">
                        <div className="bg-white rounded-2xl overflow-hidden shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
                            ...
                            <div className="p-6">
                                ...
                                <p className="text-gray-600 text-center">Description of Facility 4 goes here.</p>
                            </div>
                        </div>
                    </div>
                </div>
